...
The TypeScript SDK wraps the `o3-codex` CLI from `@o3dotdev/codex`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @o3dotdev/codex-sdk
```
...
```typescript
import { Codex } from "@o3dotdev/codex-sdk";
